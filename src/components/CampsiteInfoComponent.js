...
import {Card, CardImg, Modal, ModalHeader, ModalBody, CardText, CardBody, Label, Button, Breadcrumb, BreadcrumbItem } from 'reactstrap';
...
class CommentForm extends Component{
    ...
    handleSubmit(values){
       ...
       // console.log('Current state is: ' + JSON.stringify(this.props));
        //alert('Current state is: ' + JSON.stringify(this.props.campsiteId));
    }
    render(){
        return(
            <React.Fragment>
